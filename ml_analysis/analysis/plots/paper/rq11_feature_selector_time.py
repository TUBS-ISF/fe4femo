...
from analysis.analysis_helper import get_order, get_modified_task_time
...
df = get_modified_task_time(path+file)

plot = sns.catplot(df, x="task_time", y="feature_selector",  estimator="median", errorbar="ci", kind="boxen", orient="h", legend="auto", height=5, aspect=1.5, line_kws={"linewidth": 2},  order=get_order())
...
#plt.show()
plot.savefig("out/rq11_feature_time.pdf")