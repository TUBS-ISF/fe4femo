...
ax = sns.boxplot(df, x="model_quality", y="ml_task", order=['Runtime Kissat', 'Runtime CaDiBack', 'Runtime Spur', 'FM Cardinality', 'Backbone Size', '#SAT Algorithm Selection'], orient="h", medianprops={"linewidth": 1.5, }, fliersize=1 )
ax.set_xlim(-1,1.005)
